...
struct FullObstacle {
  var _leftTop: Position
  var _top: Position
  var _rightTop: Position
  var _right: Position
  var _rightBottom: Position
  var _bottom: Position
  var _leftBottom: Position
  var _left: Position
}
...
solve(input: {
  ...
  func readObstacles(remanding: Int, currentResult:[Position]) -> [Position] {
    ...
    return readObstacles(remanding: remanding - 1, currentResult: currentResult + [obstaclePosition])
  }
